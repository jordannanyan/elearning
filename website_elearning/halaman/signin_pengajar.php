  ...
  <div class="container py-5">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center">
        <h1 class="display-3 text-white animated slideInDown">Sign In Pengajar</h1>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            <li class="breadcrumb-item"><a class="text-white" href="index.php?h=beranda">Beranda</a></li>
            <li class="breadcrumb-item text-white active" aria-current="index.php?h=signin_pengajar">Sign In
            </li>
          </ol>
        </nav>
      </div>
...
<div class="container">
  ...
  <form action="proses/input_akun_pengajar.php" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
