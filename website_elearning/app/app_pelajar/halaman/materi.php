                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <button class="btn btn-primary">
                                        <a href='proses/download_materi_kelas.php?id=<?php echo $kelas['id_kelas'] ?>' style="color: white">Download Materi</a>
                                    </button>
                                </td>
                            </tr>
                            <?php
                    ...
                    <ul class="pagination justify-content-center mt-4">
                        ...
                        if ($totalPages > 1) {
                            if ($currentPage > 1) {
                                ?>
                                <li class="page-item">
                                    <a class="page-link" href="?h=kelas&page=<?php echo $currentPage - 1; ?>"
                                        aria-label="Previous">
