  ...
  <div class="card w-100">
    <div class="card-body p-4">
      ...
      <button class="btn btn-primary">
        <a href='index.php?h=tambah_kelas'
          style="color: white">Tambah Kelas</a>
      </button>
              ...
              <tr>
                ...
                <td class="border-bottom-0">
                  <button class="btn btn-warning">
                    <a href='index.php?h=edit_kelas&id=<?php echo $view['id'] ?>'
                      style="color: white">Edit Kelas</a>
                  </button>
                  <button class="btn btn-danger">
                    <a href='proses/hapus_kelas.php?id=<?php echo $view['id'] ?>'
                      style="color: white">Hapus Kelas</a>
                  </button>
                </td>
              </tr>
              <?php
