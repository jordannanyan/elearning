...
$insertQuery = "INSERT INTO tb_kelas (id_pengajar, judul, jurusan, durasi, tanggal, deskripsi, video, materi) VALUES (:id, :judul, :jurusan, :durasi, :tanggal, :deskripsi, :video, :materi)";
