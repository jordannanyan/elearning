...
if (isset($_FILES['profile-pic']) && $_FILES['profile-pic']['error'] === UPLOAD_ERR_OK) {
    ...
    if (in_array($fileExtension, $allowedExtensions) && in_array($fileType, $allowedMimeTypes)) {
        ...
        if (move_uploaded_file($file['tmp_name'], "../../../$destination")) {
            ...
            $insertQuery = "INSERT INTO tb_pelajar (nama, asal_sekolah, jurusan, username, password, foto) VALUES (:nama, :asal_sekolah, :jurusan, :username, :password, :foto)";
            ...
            header("Location: ../index.php?h=pelajar&msg=1");
            exit();
