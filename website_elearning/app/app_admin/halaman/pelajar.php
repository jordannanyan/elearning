...
$countQuery = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tb_pelajar");
$countResult = mysqli_fetch_assoc($countQuery);
$totalRecords = $countResult['total'];

$totalPages = ceil($totalRecords / $limit); // Total number of pages

$query = mysqli_query($koneksi, "SELECT * FROM tb_pelajar LIMIT " . $limit . " OFFSET " . $offset);
  ...
  <div class="card w-100">
    <div class="card-body p-4">
      ...
      <button class="btn btn-primary">
        <a href='index.php?h=tambah_pelajar'
          style="color: white">Tambah Pelajar</a>
      </button>
        ...
        <table class="table text-nowrap mb-0 align-middle">
          <thead class="text-dark fs-4">
            <tr>
              ...
              <th class="border-bottom-0">
                <h6 class="fw-semibold mb-0">Asal Sekolah</h6>
              </th>
              <th class="border-bottom-0">
              ...
              <tr>
                ...
                <td class="border-bottom-0">
                  <button class="btn btn-warning">
                    <a href='index.php?h=edit_pelajar&id=<?php echo $view['id'] ?>' style="color: white">Edit Pelajar</a>
                  </button>
                  <button class="btn btn-danger">
                    <a href='proses/hapus_akun_pelajar.php?id=<?php echo $view['id'] ?>' style="color: white">Hapus Pelajar</a>
                  </button>
                </td>
              </tr>
              <?php
